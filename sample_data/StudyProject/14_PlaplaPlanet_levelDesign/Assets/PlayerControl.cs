...
public class PlayerControl : MonoBehaviour {
	...
	public static float MOVE_SPEED = 7.0f; // 移動速度.// 5.0f→7.0f.
	...
	void Update() {
		...
		float eat_time = 0.5f; // リンゴは、2秒かけて食べる.// 2.0f→0.5f.

		float repair_time = 0.5f; // 修理にかかる時間も2秒.// 2.0f→0.5f.
